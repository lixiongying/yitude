//app.js
var jiekou = 'https://yitude.sxnet.cc'
App({
  onLaunch: function () {
    // 展示本地存储能力
      ...
      success: function (res) {
        ...
        if (res.code) {
          ...
          wx.request({
            ...
            url: jiekou + '/WXAPI/User/sendappid?appid=wx500b6916bb5ef2e3&secret=7ab277c732742568b7ecd3f122d2d179&js_code=' + res.code,
            data: {
              code: res.code
            },
  ...
  register: function (cb,user_ids) {
    ...
    this.getUserInfo(function () {
      ...
      wx.request({
        ...
        data: { open_id: openId, country: country, gender: gender, nickname: nickname, province: province, city: city, head_pic: avatarUrl, encryptedData: encryptedData, iv: iv, session_key: session_key, user_id: user_ids},
        header: {
